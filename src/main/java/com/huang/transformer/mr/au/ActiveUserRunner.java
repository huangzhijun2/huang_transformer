...
import com.huang.transformer.mr.TransformerOutputFormat;
...
public class ActiveUserRunner implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            logger.info("job<" + job.getJobName() + ">是否执行成功 ："  + job.isSuccessful() + "; 开始时间 ：" + strtTime + "; 结束时间 ：" + endTime + "; 用时:" + (endTime-strtTime) + "ms");
